...
function Speed(){
  const units = ["Meter per Second m/s", "Kilometer per hour km/h", "Kilometer per second km/s", "Knot kn", "Mile per hour mph", "Foot per second fps", "Inch per second ips"]
  const numbers = ['7','8', '9','4','5','6','1','2','3','.','0']
  const [m, setM] = useState(1);
  const [n, setN] = useState(1);
  const [unit1, setUnit1] = useState("Meter per Second m/s")
  const [unit2, setUnit2] = useState("Meter per Second m/s")
